    ...
    >
      <div className="glass-card w-full max-w-md rounded-3xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="p-2 mx-5 mt-4 glass-pill rounded-2xl grid grid-cols-2 gap-1 text-xs font-bold">
          <button
            ...
            className={`py-2 rounded-xl transition-all ${
              isLogin
                ? 'nav-link-active text-white shadow'
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          {!isLogin && (
            <div>
              ...
              <select
                ...
                className="glass-input w-full px-3 py-2.5 rounded-xl outline-none text-xs"
              >
                {personas.map((p) => (
          ...
          {error && (
            <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/30 text-red-500 text-xs animate-in fade-in">
              {error}
            </div>
          )}
